...
Exposed tools:
    ...
    - neuragram_recall: Search and retrieve memories
    - neuragram_smart_remember: Auto-classify and store with conflict detection
    - neuragram_forget: Delete memories
    - neuragram_list: List memories with filters
    - neuragram_stats: Get store statistics

Usage::

    # As a standalone server (stdio transport for Claude Desktop)
    python -m neuragram.server.mcp
...
def create_mcp_server(
    ...
    **kwargs: Any,
    ...
    @mcp.tool()
    async def neuragram_smart_remember(
        content: str,
        user_id: str = "",
        agent_id: str = "",
        namespace: str = "default",
